export const CONSTANT_MSG = {
  ...
  FAILED_TO_REMOVE_DEVICE_CONNECTION:
    'failed to removed rid device connnection',
  SUCCESFULLY_REMOVED_DEVICE_CONNECTION:
    'successfully removed rid devic conneciton',
  ...
  SUCCESSFULLY_ADDED_RECONFIGURATION_DETAILS:
    'failed to add reconfiguration details',
  FAILED_TO_ADD_RECONFIG_DETAILS:
    'Successfully added reconfiguration config details',
  ...
  SUCCESSFULLY_UPDATED_RID_DEVICE_ENTRY:
    'successfully updated rid device entry',
  ...
  FAILED_TO_GET_RID_DEVICE_CONNECTION_DETAILS:
    'failed to get rid device connection details',
  ...
  DELETED_USER_SUCCSSFULLY: 'delete user successfully',
  USER_DOES_NOT_EXIST: 'user does not exist',
  USER_UPDATED_SUCCESSFULLY: 'user updated successfully',
  ADDED_SUCCESSFULLY_PROJECT_DETAILS: 'added successfully project details',
  PROJECT_DETAILS_UPDATED_SUCCESSFULLY: 'project details updated successfully',
  PROJECT_DELETED_SUCCESSFULLY: 'project details deleted successfully',
  PUMPSITE_DOES_NOT_EXIST:'pumpsite does not exist',
  PUMPSITE_EXIST:'pumpsite already exist',
  ADDED_SUCCESSFULLY_PUMP_SITE:'added successfully pump site',
  PUMP_SITE_DELETED_SUCCESSFULLY:'pump site deleted successfully',
  PUMP_SITE_UPDATED_SUCCESSFULLY:'pump site updated successfully',
